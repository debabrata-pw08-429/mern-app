      ...
      <Box w="572px" margin="auto">
        ...
        <Card>
          <CardHeader display="flex">
            <Image
              ...
              src={
                img_DP
                  ? img_DP
                  : "https://www.kooapp.com/img/profilePlaceholderYellow.svg"
              }
            />
            <Box
              display="flex"
          ...
          <CardBody>
            ...
            <Button bg="#f8f7f3" borderRadius="20%" p="15px 20px" mt="10px">
              Save
            </Button>
          </CardBody>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            >
              <Image
                pr="1.4rem"
                src="https://www.kooapp.com/img/formIcon/link.svg"
              />
            ...
            <Box w="80%" ml="9%" display="flex" justifyContent="space-between">
              ...
              >
                <Image
                  w="56px"
                  h="56px"
                  src="https://www.kooapp.com/img/formIcon/fbProfile.svg"
                />
              </Button>
              <Button
                bg="none"
              ...
              >
                <Image
                  w="56px"
                  h="56px"
                  src="https://www.kooapp.com/img/formIcon/twitterProfile.svg"
                />
              </Button>
              <Button
                bg="none"
              ...
              >
                <Image
                  w="56px"
                  h="56px"
                  src="https://www.kooapp.com/img/formIcon/linkedInProfile.svg"
                />
              </Button>
              <Button
                bg="none"
              ...
              >
                <Image
                  w="56px"
                  h="56px"
                  src="https://www.kooapp.com/img/formIcon/youTubeProfile.svg"
                />
              </Button>
            </Box>
            <Modal
                ...
                <ModalHeader textAlign="center">
                  ...
                  >
                    <Image
                      w="40px"
                      h="40px"
                      src="https://www.kooapp.com/img/formIcon/facebook.svg"
                    />
                    <span>Facebook</span>
                  </Box>
                </ModalHeader>
                ...
                <ModalHeader textAlign="center">
                  ...
                  >
                    <Image
                      w="40px"
                      h="40px"
                      src="https://www.kooapp.com/img/formIcon/twitter.svg"
                    />
                    <span>Twitter</span>
                  </Box>
                </ModalHeader>
                ...
                <ModalHeader textAlign="center">
                  ...
                  >
                    <Image
                      w="40px"
                      h="40px"
                      src="https://www.kooapp.com/img/formIcon/linkedin_color.svg"
                    />
                    <span>LinkedIn</span>
                  </Box>
                </ModalHeader>
                ...
                <ModalHeader textAlign="center">
                  ...
                  >
                    <Image
                      w="40px"
                      h="40px"
                      src="https://www.kooapp.com/img/formIcon/youtube_color.svg"
                    />
                    <span>YouTube</span>
                  </Box>
                </ModalHeader>
