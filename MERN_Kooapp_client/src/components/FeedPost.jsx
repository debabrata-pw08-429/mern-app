...
function FeedPost({
  ...
  let IncreaseCount = () => {
    if (user == false) {
      ...
      console.log(
        userPostData,
        "userPostData at feed post for user if condtion"
      );
    ...
    <Card p={"2%"} m={"2%"} textAlign={"left"}>
      <Box>
        <HStack justifyContent={"space-between"}>
          <HStack onClick={redirect} style={{ cursor: "pointer" }}>
            <Avatar name={name} src={img} />
            <VStack>
              <HStack alignSelf="start" marginBottom={"-5%"}>
                <Text color={"#121212"} fontSize="16px" as="b">
                  {name}
                </Text>
                <Box marginLeft={"41%"} marginTop={"-6%"}>
        ...
        <Box marginTop={"5%"} style={{ cursor: "pointer" }}>
          <Text color={"#1E63BD"}>{myHashTags}</Text>
        </Box>
        <Box marginTop={"3%"}>
          <Image
            maxHeight={"500px"}
        ...
        <Box marginTop={"2%"}>
          <HStack>
            <Button color={"#121212"} backgroundColor={"#E8E8E3"}>
              <Text fontSize="14px">English</Text>
            </Button>
            <Button color={"#888888"} backgroundColor={"#FFFFFF"}>
              <Text fontSize="14px">हिन्दी</Text>
            </Button>
            <Button color={"#888888"} backgroundColor={"#FFFFFF"}>
              <Text fontSize="14px">ಕನ್ನಡ</Text>
            </Button>
            <Button color={"#888888"} backgroundColor={"#FFFFFF"}>
              <Text fontSize="14px">தமிழ்</Text>
            </Button>
            <Button color={"#888888"} backgroundColor={"#FFFFFF"}>
              <Text fontSize="14px">తెలుగు</Text>
            </Button>
            <Button color={"#888888"} backgroundColor={"#FFFFFF"}>
              <Text fontSize="14px">मराठी</Text>
            </Button>
            <Button color={"#888888"} backgroundColor={"#FFFFFF"}>
              <Text fontSize="14px">বাংলা</Text>
            </Button>
            <Box>
              <FcComboChart />
            </Box>
